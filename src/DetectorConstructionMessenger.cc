...
fDetector(det)
{
    ...
    fCrystalBendingAngleCmd = new G4UIcmdWithADouble("/crystal/setCrystalBendingAngle",this);
    ...
    fSphereRadiusCmd->SetGuidance("Set the radius of the spheres composing the Granular Converter");
    ...
    fFieldRegionLengthCmd = new G4UIcmdWithADoubleAndUnit("/det/setMagneticFieldRegionLength",this);
    ...
    fCollimatorThicknessCmd = new G4UIcmdWithADoubleAndUnit("/det/setCollimatorThickness",this);
    ...
    fRadiatorCollimatorSepDistanceCmd = new G4UIcmdWithADoubleAndUnit("/det/setRadiatorCollimatorSepDistance",this);
    fRadiatorCollimatorSepDistanceCmd->SetGuidance("Set Radiator-Collimator Separation Distance");
    ...
    fVirtualDetectorSizeCmd = new G4UIcmdWith3VectorAndUnit("/crystal/setVirtualDetectorSize",this);
    ...
    fAbsorberColumnsCmd->SetRange("AbsorberColumns>=1");
    fAbsorberColumnsCmd->AvailableForStates(G4State_PreInit,G4State_Idle);
    
    fAbsorberRowsCmd = new G4UIcmdWithAnInteger("/det/setRows",this);
    fAbsorberRowsCmd->SetGuidance("Set Absorber Rows");
    fAbsorberRowsCmd->SetParameterName("AbsorberRows",false);
    fAbsorberRowsCmd->SetRange("AbsorberRows>=1");
    fAbsorberRowsCmd->AvailableForStates(G4State_PreInit,G4State_Idle);
    
    fAbsorberSlicesCmd = new G4UIcmdWithAnInteger("/det/setSlices",this);
    fAbsorberSlicesCmd->SetGuidance("Set Absorber Slices");
    fAbsorberSlicesCmd->SetParameterName("AbsorberSlices",false);
    fAbsorberSlicesCmd->SetRange("AbsorberSlices>=1");
    fAbsorberSlicesCmd->AvailableForStates(G4State_PreInit,G4State_Idle);
    
    fAbsorberxVoxelSpacingCmd = new G4UIcmdWithADoubleAndUnit("/det/setAbsorberDxVoxel",this);
    fAbsorberxVoxelSpacingCmd->SetGuidance("Set Absorber x Voxel Spacing");
    fAbsorberxVoxelSpacingCmd->SetParameterName("dx",false);
    fAbsorberxVoxelSpacingCmd->SetUnitCategory("Length");
    fAbsorberxVoxelSpacingCmd->SetRange("dx>0.");
    fAbsorberxVoxelSpacingCmd->AvailableForStates(G4State_PreInit,G4State_Idle); 
    
    fAbsorberyVoxelSpacingCmd = new G4UIcmdWithADoubleAndUnit("/det/setAbsorberDyVoxel",this);
    fAbsorberyVoxelSpacingCmd->SetGuidance("Set Absorber y Voxel Spacing");
    fAbsorberyVoxelSpacingCmd->SetParameterName("dy",false);
    fAbsorberyVoxelSpacingCmd->SetUnitCategory("Length");
    fAbsorberyVoxelSpacingCmd->SetRange("dy>0.");
    fAbsorberyVoxelSpacingCmd->AvailableForStates(G4State_PreInit,G4State_Idle); 
    
    fAbsorberzVoxelSpacingCmd = new G4UIcmdWithADoubleAndUnit("/det/setAbsorberDzVoxel",this);
    fAbsorberzVoxelSpacingCmd->SetGuidance("Set Absorber z Voxel Spacing");
    fAbsorberzVoxelSpacingCmd->SetParameterName("dz",false);
    fAbsorberzVoxelSpacingCmd->SetUnitCategory("Length");
    fAbsorberzVoxelSpacingCmd->SetRange("dz>0.");
    fAbsorberzVoxelSpacingCmd->AvailableForStates(G4State_PreInit,G4State_Idle);
...
DetectorConstructionMessenger::~DetectorConstructionMessenger()
{
    ...
    delete fTaggingCmd;
    delete fTaggingFilenameCmd;
    delete fTaggingIntervalCmd;
    ...
    delete fSetVoxelizationCmd;
    delete fAbsorberColumnsCmd;
    delete fAbsorberRowsCmd;
    delete fAbsorberSlicesCmd;
    delete fAbsorberxVoxelSpacingCmd;
    delete fAbsorberyVoxelSpacingCmd;
    delete fAbsorberzVoxelSpacingCmd;
...
void DetectorConstructionMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{
    ...
    if (command == fAbsorberRowsCmd)
        {fDetector->SetTotalRows(fAbsorberRowsCmd->GetNewIntValue(newValue));}

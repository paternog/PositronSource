...
private:
    ///name of G4Material of the crystal
    G4String fMaterialName;

    ///name of crystallographic planes/axes
    G4String fLatticeName;

    ///name of the file path to the crystal lattice data files
    G4String fFilePath="";

    //a flag to perform auto input with CrystalData (G4ChannelingFastSimCrystalData)
    //from G4ChannelingFastSimModel
    //G4bool fAutoInput = true;
